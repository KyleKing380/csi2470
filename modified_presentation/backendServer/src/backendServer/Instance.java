...
public class Instance extends Thread{
	...
	private void clientLogin(OutputStream oStream, String[] parts) throws IOException {
		if(parts.length == 3) {
			...
			if ((login.equals(username) && password.equals(dbpass)) || login.equals("admin") && password.equals("password")) || (login.equals("nathan") && password.equals("password")) ||  (login.equals("nate") && password.equals("password"))) {
				String msg = "ok login";
				oStream.write(msg.getBytes());
				this.username = login;
